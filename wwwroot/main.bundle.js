...
var AppService = /** @class */ (function () {
    ...
    function AppService(_http) {
        this._http = _http;
        this.tvShowUrl = 'api/TvShow';
    }
    AppService.prototype.getTvShows = function () {
        return this._http.get(this.tvShowUrl).map(function (response) {
